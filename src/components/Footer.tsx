      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <a href="#" className="text-2xl font-semibold text-primary mb-4 block">COMPU.UY</a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:+59899123456" className="text-gray-600 hover:text-primary">
                  +598 99 123 456
                </a>
              </li>
              <li>
                <a href="mailto:info@compu.uy" className="text-gray-600 hover:text-primary">
                  info@compu.uy
                </a>
              </li>
            </ul>
